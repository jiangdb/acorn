...
void MCU_Initialization(void)
{
	...
	//PT1端口[7:1]
	//-------------------------------
	PT1CON = 0x00;					//PT1CON:(上电默认值:00000000)
	...
	//-------------------------------
	//PT3端口[7:0]，设置P3.1/P3.3/P3.4为AD模拟输入口
	//-------------------------------
	PT3CON	= 0x16;					//PT3CON:(上电默认值:00000000)
