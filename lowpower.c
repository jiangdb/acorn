...
//	;IO口设置(若IO口悬空，则要置为输出或者输入带上/下拉)
		PT1PU = 0x00;                   //I/O口上拉电阻设置                                                       
		PT1EN = 0x7B;					//pt1.2,pt1.7作输入口                                                          
		PT1CON = 0x02;
		PT1CON1 = 0x01;					//pt1.2中断使能
		PT1 = 0x02;                                                        
		...
		PT5PU = 0x00;                                                       
		PT5EN = 0x07;					//pt5.0,pt5.1,pt5.2为输出                                                             
		PT5CON = 0x00;                                               
		PT5 = 0x03;						//pt5.0,pt5.1 default high
...
//	;中断设置
		...
		INTF2 = 0x00;               //关闭其他中断                                            
		INTE2 = 0x00;                                      
		INTE = 0x83;				//开启外部中断0、开启外部中断1、总中断使能 
		INTE2 = 0X00;
		INTE3 = 0X00;		
//	;----------------------------------------
//	;看门狗、时钟设置
